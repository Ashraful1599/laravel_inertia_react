...
export default function Edit({products,review}) {


        const options = []
        products.map((item, index)=> options[index] = {value: item.id, label: '#'+item.id+' '+item.name} )
            ...
            <div className="card mb-4">
                ...
                <form onSubmit={submitHandle}>
                    ...
                    <label className="col-sm-2 col-form-label">Product</label>
                        ...
                        value = {
                            options.filter(option =>  option.value === data.product_id)
                         } 
                        name='product_id'
                    //    isMulti
                    ...
                    <label className="col-sm-2 col-form-label">Product</label>
                        ...
                        <select onChange={inputHandle} defaultValue={data.rating}  name="rating" className='form-select'>
