...
export default function ProductCreate({categories, tags, terms, attributes}) {
...
<div className="form-check form-check-inline">
    ...
    <input onChange={inputHandle}  defaultChecked name='product_type' className="form-check-input" type="radio" id="inlineCheckbox1" value="simple" />
</div>
<div className="form-check form-check-inline">
    <label className="form-check-label" htmlFor="inlineCheckbox2">Variable</label>
    <input onChange={inputHandle}   name='product_type' className="form-check-input" type="radio" id="inlineCheckbox2" value="variable" />
</div>
</div>
