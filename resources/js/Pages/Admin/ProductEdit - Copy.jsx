...
//console.log(varArr);
  ...
  const [arr, setArr] = useState(varArr);
  ...
  const AddHandleChange = e => {
    ...
    setArr(s => {
     ...
     if(e.target.name == 'variablePrice'){
        newArr[index].price = e.target.value;
        return newArr;
     }else if(e.target.name == 'variableSize'){
        newArr[index].size = e.target.value;
        return newArr;
     }else if(e.target.name == 'variableColor'){
                                ...
                                <div key={i} className="row mt-3">

                                    {
                                        attributes.map((item, index)=>{
                                            ...
                                            {
                                                var objectName = item.name.toLowerCase();
                                             //   console.log(objectName);
                                                var attribute_i = var_item[objectName];
                                              //  console.log(attribute_i);
                                            }

                                            return(
                                                <div key={index} className="col-sm">
                        
                                                    <select defaultValue={attribute_i}   name={'variable'+item.name} onChange={AddHandleChange} id={i} className='form-select'>
                                    ...
                                    <div  className="col-sm">
                                     <button type="button"  className="btn btn-danger " onClick={() => removeFormFields(i)}>Remove</button>
                                    </div>
                                </div>
                ...
                <div className="card mb-4 nav-sticky">
                    ...
                    <div className="form-group">
                        <label className="col-sm-2 col-form-label">Category</label>
                            <select className="form-control" onChange={inputHandle} name="cat_id" defaultValue={data.cat_id}>
                        ...
                        <div className="form-group">
                            ...
                            <select className="form-control" onChange={inputHandle} name="tag_id" defaultValue={data.tag_id}>
