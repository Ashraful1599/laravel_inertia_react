...
export default function TermIndex({ terms }) {
    ...
    const columns = [
        {
            name: "Attribute name",
            selector: row => row.attribute.name,
            sortable: true
        },       
         {
            name: "Term Name",
    ...
    const contextActions = React.useMemo(() => {
        const handleDelete = () => {
            if (
                ...
                Inertia.delete(route("term.destroy", selectedItemString));
    ...
    const filteredItems = terms.filter(
        item =>
            (item.name &&
            ...
            <div className="container-xl px-4">
                <div className="card mb-4">
                    ...
                    <div className="card-body">
                        ...
                        <DataTable
                            title="Term List" //must enable the title to show selected row and button
                            columns={columns}
                            data={filteredItems}
                            pagination
